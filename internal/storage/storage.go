...
func pickStorage(storageType, path string, keyringAvailable bool, warn io.Writer) Storage {
	...
	case "keyring":
		...
		fmt.Fprintln(warn, "    - acknowledge plaintext storage and silence this warning, either by")
		fmt.Fprintln(warn, "      setting NDCLI_AUTH_STORAGE=file, or by adding to your ndcli config.yaml:")
		fmt.Fprintln(warn, "")
